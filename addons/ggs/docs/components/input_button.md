Displays the assigned [Input Confirm Window](https://github.com/PunchablePlushie/godot-game-settings/wiki/Input-Confirm-Window) when pressed and rebinds input.
